...
public class TransactionController {
    ...
    public ResponseEntity<List<Transaction>> getByUserID(@PathVariable Long userId) {
    	logger.debug("TransactionController-getByUserID() call started"); 
    	List<Transaction> getAllTxnData =transactionService.getTransactionsByUserID(userId);
    	logger.info("TransactionController-getByUserID() call ended");
    	return ResponseEntity.status(HttpStatus.CREATED).body(getAllTxnData);
